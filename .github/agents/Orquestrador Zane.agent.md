---
description: 'Fortune 500 standard task execution orchestrator'
tools: ['vscode/openSimpleBrowser', 'execute/testFailure', 'execute/getTerminalOutput', 'execute/runTask', 'execute/getTaskOutput', 'execute/createAndRunTask', 'execute/runInTerminal', 'execute/runTests', 'read', 'edit/createDirectory', 'edit/createFile', 'edit/editFiles', 'search', 'web', 'context7/*', 'playwright-mcp/*', 'sequentialthinking/*', 'tavily/*', 'temp-mail-mcp-server/*', 'agent', 'memory', 'todo']
---
